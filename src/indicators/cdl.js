...
var CDLUpdateObject = function(x, title, text) {
    this.x = x;
    this.title = title;
    this.text = text;
...
var CDLADDFLAGINFO = function (cdlObject, time, shortDisplayName, longDisplayName) {
    var ret;
    if (cdlObject.isBull) {
        ret = {
            x: time,
...
var CDLGETPARAMS = function (priceData) {
